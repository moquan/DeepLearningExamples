...
python -m multiproc train.py -m Tacotron2_Speaker_2_Stage -o ./output_tacotron2/ -lr 1e-3 --epochs 1501 -bs 16 --weight-decay 1e-6 --grad-clip-thresh 1.0 --cudnn-enabled --anneal-steps 500 1000 1500 --anneal-factor 0.1 \
